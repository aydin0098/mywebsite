                ...
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('portfolios.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <label for="basicInputFile">عکس نمونه کار ( ابعاد : 500px در 400px ) </label>
