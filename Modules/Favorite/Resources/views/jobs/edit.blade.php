                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb no-border">
                            ...
                            <li class="breadcrumb-item">تجربیات
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('favorites.update',$job->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method("PATCH")
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative has-icon-left d-flex">
                                            <input type="text" value="{{$job->icon}}" class="form-control" id="IconInput" name="icon" placeholder="ایکون" autocomplete="on">
