            ...
            <div class="card">
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="card-header">ویرایش کاربر {{$user->name}}</div>
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('users.update',$user->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="row">
