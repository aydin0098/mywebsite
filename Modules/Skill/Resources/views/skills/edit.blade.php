                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb no-border">
                            ...
                            <li class="breadcrumb-item">مهارت
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <section class="users-edit">
            <div class="card">
                <div id="main-card" class="card-content">
                    <div class="card-header">ویرایش مهارت {{$skill->title}}</div>
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('skills.update',$skill->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <div class="controls">
                                                <label>میزان توانایی ( به درصد)</label>
                                                <input type="number" value="{{$skill->average}}" name="average" class="form-control">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
