...
@section('title','شبکه اجتماعی جدید')
@section('styles')
                ...
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('socials.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="position-relative has-icon-left d-flex">
                                            <input type="text" class="form-control" id="IconInput" name="icon" placeholder="ایکون" autocomplete="on">
