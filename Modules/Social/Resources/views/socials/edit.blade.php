                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb no-border">
                            ...
                            <li class="breadcrumb-item">شبکه های اجتماعی
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="card">
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="card-header">ویرایش ایتم {{$social->name}}</div>
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('socials.update',$social->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="position-relative has-icon-left d-flex">
                                            <input type="text" class="form-control" value="{{$social->icon}}" id="IconInput" name="icon" placeholder="ایکون" autocomplete="on">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>نام</label>
                                                <input type="text" value="{{$social->name}}" name="name" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <div class="controls">
                                                <label>لینک</label>
                                                <input type="text" value="{{$social->link}}" name="link" class="form-control">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
