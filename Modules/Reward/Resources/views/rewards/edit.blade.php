                ...
                <div class="col-12">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb no-border">
                            ...
                            <li class="breadcrumb-item">جوایز
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div id="main-card" class="card-content">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('rewards.update',$reward->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <label for="basicInputFile">عکس جایزه</label>
                                            <div class="custom-file">
                                                <input type="file" accept="image/*" name="image" class="custom-file-input">
                                                <label class="custom-file-label" for="inputGroupFile01">{{$reward->image}}</label>
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="controls">
                                                ...
                                                <input type="text" value="{{$reward->title}}" name="title" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <div class="controls">
                                                <label>محل کسب جایزه</label>
                                                <input value="{{$reward->description}}" type="text" name="description" class="form-control">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
