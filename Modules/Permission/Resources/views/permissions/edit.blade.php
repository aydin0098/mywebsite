            ...
            <div class="card">
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        ...
                        <div class="card-header">ویرایش دسترسی {{$permission->label}}</div>
                        ...
                        <div class="tab-content">
                            ...
                            <form id="information-form" action="{{ route('permissions.update',$permission->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="controls">
                                                <label>نام دسترسی به لاتین</label>
                                    ...
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <div class="controls">
                                                <label>توضیحات</label>
                                                <input type="text" value="{{$permission->label}}" name="label" class="form-control">
                                            </div>
                                        </fieldset>
                                    </div>
                                </div>
